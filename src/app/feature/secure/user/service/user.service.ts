...
export class UserService {
  ...
  getUser():Observable<any>{
    return this.commServ.get<any>(UserAPI.getUserList(),null,null,false,false)
  }

  addUser(user:any):Observable<any>{
    return this.commServ.post<any>(UserAPI.addUser(),user,null,false,false)
  }
  ...
  updateUser(userId:number,updatedUser:any):Observable<any>{
    ...
    return this.commServ.put<any>(url,updatedUser)
  }
